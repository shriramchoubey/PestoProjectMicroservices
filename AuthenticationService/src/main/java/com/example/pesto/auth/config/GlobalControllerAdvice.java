package com.example.pesto.auth.config;



import com.example.pesto.auth.exceptions.ExceptionResponseDTO;
import com.example.pesto.auth.exceptions.PestoException;
...
public class GlobalControllerAdvice {
    ...
    public ResponseEntity<String> MissingServletRequestPartException(
        ...
        String message = "{\"message\": \" Required params missing\"}";
        return new ResponseEntity<String>(message, HttpStatus.BAD_REQUEST);
    }
